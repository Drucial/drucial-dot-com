...
export default function Form() {
	...
	const valName = () => {
		if (document.contactForm.Name.value === "") {
			nameRef.current.innerHTML =
				"Name <em style='color: #a1210d'>* Please provide your name</em>";
	...
	const valEmail = () => {
		if (document.contactForm.Email.value === "") {
			mailRef.current.innerHTML =
				"Email <em style='color: #a1210d'>* Please provide your email</em>";
	...
	const valMessage = () => {
		if (document.contactForm.Message.value === "") {
			messageRef.current.innerHTML =
				"Message <em style='color: #a1210d'>* Please include a message</em>";
		...
		<>
			{success === false ? (
				...
				>
					...
					<label ref={mailRef} htmlFor="Email">
						Email
					</label>
					<input
						type="email"
					...
					<div className="btn-container">
						<button type="button" className="submit-button" onClick={validate}>
							Send
						</button>
					</div>
